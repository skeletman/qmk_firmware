...
[LAYR] = LAYOUT_ergodox(
    ...
    // right hand
       ...
       TO(BASE),  KC_NO,  KC_NO, KC_NO, TO(OP),     KC_NO, KC_NO,
                  KC_NO,  KC_NO, KC_NO, TO(LOGIC),  KC_NO, KC_NO,
       KC_NO,     KC_NO,  KC_NO, KC_NO, KC_NO,      KC_NO, KC_NO,
                          KC_NO, KC_NO, KC_NO,      KC_NO, KC_NO,
       KC_NO, KC_NO,
       KC_NO,
...
[LAYRONESHOT] = LAYOUT_ergodox(
    ...
    // right hand
       ...
       TO(BASE),  KC_NO,  KC_NO, KC_NO, OSL(OP),    KC_NO, KC_NO,
                  KC_NO,  KC_NO, KC_NO, OSL(LOGIC), KC_NO, KC_NO,
       KC_NO,     KC_NO,  KC_NO, KC_NO, KC_NO,      KC_NO, KC_NO,
                          KC_NO, KC_NO, KC_NO,      KC_NO, KC_NO,
       KC_NO, KC_NO,
       KC_NO,
...
[LOGIC] = LAYOUT_ergodox( 
        // left hand
        KC_TRNS,         KC_TRNS,       KC_TRNS, KC_TRNS,  KC_TRNS, KC_TRNS,  KC_TRNS,
        KC_TRNS,         X(nproves),         X(ntautology),   X(nforces),    X(utack),    KC_NO,     KC_TRNS,
        KC_TRNS,         X(rtack),         X(tautology),   X(forces),      X(dtack),    KC_NO,
        KC_TRNS,         X(assertion),         X(models),   KC_NO,      X(ltack),    KC_NO,     KC_TRNS,
        KC_TRNS,         KC_TRNS,       KC_TRNS, KC_TRNS,    KC_TRNS,
                                               KC_TRNS,        KC_TRNS,
                                                              KC_TRNS,
                                               KC_TRNS,KC_TRNS,KC_TRNS,
        // right hand
             KC_TRNS,     KC_TRNS,    KC_TRNS,  KC_TRNS,   X(curlyand),        X(curlyor),    KC_TRNS, 
             KC_TRNS,     KC_NO,      X(naryand),    X(naryor),      X(udot),       X(uplus),          KC_TRNS,
                          X(not),      X(and),    X(or),      X(forall),      X(exists),          KC_TRNS,
             KC_TRNS,     X(xor),      X(nand),    X(nor),      KC_NO,      X(nexists),          KC_TRNS,
                                  KC_TRNS, KC_TRNS,KC_TRNS,KC_TRNS,          KC_TRNS,
             KC_TRNS,        KC_TRNS,
             KC_TRNS,
             KC_TRNS,KC_TRNS, KC_TRNS
...
[REL] = LAYOUT_ergodox( 
        ...
        KC_TRNS,         XP(tilde, 0),         XP(tildeq, 0),   XP(tildeqq, 0),    XP(approx, 0),    X(tripletilde),     KC_TRNS,
        KC_TRNS,         XP(equal, 0),         XP(tripleeq, 0),   X(quadeq),      X(coloneq),    X(eqcolon),
...
[CALC] = LAYOUT_ergodox( 
        ...
        KC_TRNS,         X(increment),   X(nabla),      X(partiald),   X(infty),    KC_NO,
